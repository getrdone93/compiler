...
parse :	parse.o scanner.o symbolTable.o nodeNames.o quad_gen.o quad.o helper_funcs.o
	$(CC) $(LOPT) -o parse parse.o scanner.o symbolTable.o nodeNames.o quad_gen.o quad.o helper_funcs.o
...
test :	parse
	echo "\na_test10.c"
	-./parse testFiles/input_progs/a_test10.c- > /dev/null
